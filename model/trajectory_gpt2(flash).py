...
class Attention(nn.Module):
    ...
    def forward(
        ...
        attn_outputs = F.scaled_dot_product_attention(query,key,value,attn_mask=attention_mask,dropout_p = self.attn_dropout_rate,is_causal=True,scale=self.scale)#self._attn(query, key, value, attention_mask, head_mask, output_attentions)
        a = attn_outputs[0]
